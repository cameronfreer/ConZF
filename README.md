...
| `ConZF/Assign.lean` | finite assignments as sets (gate 2, step A): pure set-coded functions from a numeral into a domain set, the formula and its bridge, the internal set of all assignments into a member, cons of a value with its formula and bridge, existence of the cons in the class, and value reading |
